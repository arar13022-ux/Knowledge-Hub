...
export default function FeedbackPage() {
  ...
  // Republish: brings the article back AND clears every outdated report for it,
  // since republishing means the issue's been fixed
              ...
              <div key={f.id} className="border-t border-black/5 dark:border-white/10 pt-3 first:border-t-0 first:pt-0">
                ...
                {f.articles && (
                  <div className="flex gap-2 mt-2">
                    {isArchived ? (
                      <button
                        onClick={() => republish.mutate(f.articles!.id)}
